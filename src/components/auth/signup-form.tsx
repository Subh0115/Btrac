        ...
        <div className="flex flex-col text-center w-full">
            ...
            >
                ...
                <p className="text-sm text-muted-foreground mt-2">
                    {isEmailOpen
                        ? "Create an account to start using BtrackiFiS"
                        : isCodeSent
                            ...
                            >
                                ...
                                <div className="w-full">
                                    <Button
                                        type="submit"
                                        disabled={isEmailLoading}
                                        className="w-full bg-gradient-to-r from-white via-white/90 to-white text-primary hover:from-white/90 hover:to-white animate-background-shine bg-[200%_auto]"
                                    >
